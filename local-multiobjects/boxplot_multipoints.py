...
patch_colors = ['yellow', 'white', 'white', 'white', 'white', 'white']       #高亮mangrove
...
axs[1, 1].set_ylim([0, upper_limit_2])
axs[2, 0].set_ylim([0, upper_limit_3])
axs[2, 1].set_ylim([0, upper_limit_3])
