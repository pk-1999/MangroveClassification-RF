...
var S2_All = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED").filterDate(start, end);
...
var ReferenceSample = Reference.map(function(feature) {
    ...
    var S2 = S2_All.filterBounds(feature.geometry());
    ...
    var samplePoints = S2.select(bands).sampleRegions({
        collection: sample,   //采样范围，此处指从Points中的所有点
