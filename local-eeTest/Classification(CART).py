...
# Create the urban feature collection.
...
# Create the vegetation feature collection.
...
# Create the water feature collection.
water = ee.FeatureCollection([
  ee.Feature(ee.Geometry.Point([-122.61085510253906, 37.835095568009415]),
      {
        "landcover": 2,
        "system:index": "0"
      }),
...
landsatCollection = ee.ImageCollection('LANDSAT/LC08/C02/T1').filterDate('2017-01-01', '2017-12-31')
...
print("training:")
pprint(training.getInfo())

# Train a CART classifier.
classifier = ee.Classifier.smileCart().train(features=training, classProperty=classProperty)
# Print some info about the classifier (specific to CART).
print("CART, explained:")
pprint(classifier.explain())
...
# Optionally, do some accuracy assessment.
...
print("trainingPatition:")
pprint(trainingPartition.getInfo())
print("testingPartition")
pprint(testingPartition.getInfo())
...
pprint(confusionMatrix.getInfo())
